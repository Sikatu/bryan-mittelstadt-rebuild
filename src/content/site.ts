...
export const siteConfig: SiteConfig = {
  ...
  shortBio:
    ...
    'television, stage, voice-over, music, and independent filmmaking.',
  ...
  longBio:
    ...
    'When not in front of the camera, Bryan is completing his upcoming folk album and scripts, ' +
    'playing guitar, or traveling.\n\n' +
